...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.13.0"
  WORKING_DIRECTORY "/root/SAGE/sage_ext/sage_db/build/_deps/pybind11-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/SAGE/sage_ext/sage_db/build/_deps/pybind11-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/SAGE/sage_ext/sage_db/build/_deps/pybind11-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
