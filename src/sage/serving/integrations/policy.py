...
SUPPORTED_DIRECT_ENDPOINT_VARIANTS = frozenset(
    {
        ...
        ("ablation", "shaping-only"),
        ("ablation", "deferral-only"),
...
DIRECT_ENDPOINT_VARIANT_POLICIES: dict[tuple[str, str], dict[str, Any]] = {
    ...
    ("ablation", "shaping-only"): {
        "mode": "fifo",
        "policy_family": "vamos-ablation",
        "control_objective": "objective-shaping-without-flow-control",
        "deadline_class_max_tokens": {
            "interactive-high": 16,
            "batch-standard": 64,
            "long-generation-standard": 64,
    ...
    ("ablation", "deferral-only"): {
        ...
        "admission_control": False,
        "policy_family": "vamos-ablation",
        "control_objective": "bounded-deferral-with-original-objectives",
    },
    ("ablation", "admission-only"): {
        "mode": "load-aware",
        "defer_interval_sec": 0.25,
        ...
        "admission_control": True,
        "policy_family": "vamos-ablation",
        "control_objective": "bounded-deferral-and-admission-with-original-objectives",
    },
    ("ablation", "no-profiling"): {
        "mode": "no-profiling",
        "defer_interval_sec": 0.5,
