# sage.bak/core/embedding_model/text_preprocessor.py
import numpy as np
import torch
...
class TextPreprocessor:
    ...
    def generate_embedding_with_sliding_window(self, text: str, max_length=512, stride=256):
        """
        Generate an embedding_model for the given text using a sliding window approach.
        """
        ...
        with torch.no_grad():
            for input_ids in inputs["input_ids"]:
                ...
                # Mean pooling to obtain the embedding_model
        ...
        # Adjust the aggregated embedding_model to match the fixed dimension
        ...
        # Return the embedding_model as a float32 PyTorch Tensor
        return aggregated_embedding.to(dtype=torch.float32)

    def generate_embedding(self, text: str):
        """
        Generate a fixed-dimension embedding_model for the given text using the model.
        """
        ...
        # Ensure the embedding_model has the correct fixed dimension
