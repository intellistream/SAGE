...
class SharedResource:
    ...
    def __eq__(self, other):
        ...
        return (hasattr(other, 'name') and hasattr(other, 'data') and
                self.name == other.name and self.data == other.data)
...
class TestObjectReferenceIntegrity:
    ...
    def test_multiple_shared_objects(self):
        ...
        # 序列化后检查
        assert restored_root.obj1.obj1 is restored_root.obj2.obj1, "restored shared1应该是同一个对象"
        assert restored_root.obj1.obj2 is restored_root.obj2.obj2, "restored shared2应该是同一个对象"
    ...
    def test_deep_nested_sharing(self):
        ...
        # 序列化前检查
        assert level1["data"]["nested"]["shared"] is level1["direct_shared"], "深度嵌套的共享对象应该相同"
        ...
        # 序列化后检查
        assert restored["data"]["nested"]["shared"] is restored["direct_shared"], "恢复后深度嵌套的共享对象应该相同"
