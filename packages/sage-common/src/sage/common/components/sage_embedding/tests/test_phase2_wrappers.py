...
class TestAPIKeyMethods:
    ...
    def test_openai_requires_api_key(self):
        ...
        import os
        from sage.components.sage_embedding import OpenAIEmbedding
        # 临时清除环境变量
    ...
    def test_jina_requires_api_key(self):
        """测试 Jina 需要 API Key"""
        import os
        from sage.components.sage_embedding import JinaEmbedding
    ...
    def test_zhipu_requires_api_key(self):
        """测试 Zhipu 需要 API Key"""
        import os
        from sage.components.sage_embedding import ZhipuEmbedding
    ...
    def test_cohere_requires_api_key(self):
        ...
        import os
        from sage.components.sage_embedding import CohereEmbedding
    ...
    def test_bedrock_requires_credentials(self):
        ...
        import os
        from sage.components.sage_embedding import BedrockEmbedding
        # 保存并清除 AWS 凭证
        old_keys = {
    ...
    def test_siliconcloud_requires_api_key(self):
        ...
        import os
        from sage.components.sage_embedding import SiliconCloudEmbedding
    ...
    def test_nvidia_openai_requires_api_key(self):
        ...
        import os
        from sage.components.sage_embedding import NvidiaOpenAIEmbedding
        old_key = os.environ.pop("OPENAI_API_KEY", None)
        try:
            with pytest.raises(RuntimeError, match="需要 API Key"):
