"""
Test suite for sage.kernels.runtime.dispatcher module
...
class TestDispatcher:
    ...
    def local_dispatcher(self, mock_graph, mock_env):
        ...
        with patch('sage.kernels.runtime.dispatcher.ensure_ray_initialized'):
    ...
    def remote_dispatcher(self, mock_graph, mock_remote_env):
        ...
        with patch('sage.kernels.runtime.dispatcher.ensure_ray_initialized') as mock_ray:
    ...
    @pytest.mark.integration
    @patch('sage.kernels.runtime.distributed.ray.ensure_ray_initialized')
    def test_dispatcher_ray_integration(self, mock_ray_init, mock_graph):
        ...
        with patch('sage.kernels.runtime.dispatcher.ensure_ray_initialized') as dispatcher_ray_mock:
