...
class TestTerminateProcessesByName:
    ...
    def test_terminate_multiple_processes(self):
        ...
        with patch('sage.common.utils.system.process.find_processes_by_name', return_value=mock_procs):
...
class TestTerminateProcessTree:
    ...
    def test_terminate_tree_success(self):
        ...
        with patch('sage.common.utils.system.process.get_process_children', return_value=[1001, 1002]):
            with patch('sage.common.utils.system.process.terminate_process') as mock_terminate:
                mock_terminate.side_effect = [
...
class TestSudoManager:
    ...
    def test_get_sudo_password_success(self):
        ...
        with patch('getpass.getpass', return_value="test_password"):
            with patch('sage.common.utils.system.process.verify_sudo_password', return_value=True):
    ...
    def test_get_sudo_password_invalid(self):
        ...
        with patch('getpass.getpass', return_value="wrong_password"):
            with patch('sage.common.utils.system.process.verify_sudo_password', return_value=False):
                with patch('builtins.print'):
                    password = manager.get_sudo_password()
