...
class TestStateHelperFunctions:
    ...
    def test_filter_attrs_with_include(self):
        ...
        attrs = {"include_me": "value1", "exclude_me": "value2", "another": "value3"}
    ...
    def test_filter_attrs_with_exclude(self):
        ...
        attrs = {"keep_me": "value1", "exclude_me": "value2", "also_keep": "value3"}
    ...
    def test_prepare_nested_structures(self):
        ...
        nested_data = {
            "level1": {"level2": [1, 2, {"level3": "deep_value"}]},
...
class TestStateEdgeCases:
    ...
    def test_prepare_very_large_structure(self):
        ...
        combined = {"dict": large_dict, "list": large_list}
