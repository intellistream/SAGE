...
from sage.kernel.cli.head_manager import app, get_conda_init_code
...
class TestHeadStart:
    ...
    @pytest.mark.unit
    @patch('sage.kernel.cli.head_manager.get_config_manager')
    @patch('sage.kernel.cli.head_manager.subprocess.run')
...
class TestIntegration:
    ...
    @patch('sage.kernel.cli.head_manager.get_config_manager')
    @patch('sage.kernel.cli.head_manager.Path')
    @patch('sage.kernel.cli.head_manager.subprocess.run')
