...
def assert_service_lifecycle_state(service, setup=False, started=False, stopped=False, cleaned=False):
    """断言服务生命周期状态"""
...
class ErrorSimulator:
    ...
    @staticmethod
    def create_conditional_error_function(error_condition, error_type=RuntimeError, error_message="Conditional error"):
        """创建条件错误函数"""
...
class IntegrationTestHelper:
    ...
    def create_full_pipeline_scenario():
        """创建完整管道场景"""
        from sage.kernel.api.pipeline import Pipeline, DataTransformStep, FilterStep
...
class CoverageTestHelper:
    ...
    def test_all_public_methods(obj, exclude_methods=None):
        ...
        public_methods = [method for method in dir(obj) 
    ...
    def test_all_properties(obj):
        """测试对象的所有属性"""
        properties = [prop for prop in dir(obj) 
