...
from sage.kernel.kernels.runtime.serialization.universal import UniversalSerializer
...
class TestUniversalSerializer:
    ...
    @pytest.mark.unit
    @patch('sage.kernel.kernels.runtime.serialization.universal.dill')
    ...
    @pytest.mark.unit
    @patch('sage.kernel.kernels.runtime.serialization.universal.dill.dumps')
    ...
    @pytest.mark.unit
    @patch('sage.kernel.kernels.runtime.serialization.universal.dill.loads')
