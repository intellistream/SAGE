...
def test_multithreading_concurrency():
    ...
    try:
        from sage.kernel.kernels.runtime.communication.queue_descriptor import create_python_queue
...
def test_sage_queue_concurrency():
    ...
    try:
        from sage.kernel.kernels.runtime.communication.queue_descriptor import create_sage_queue
...
def test_serialization():
    ...
    try:
        ...
        if queue_desc.can_serialize:
            ...
            # 从字典恢复
            from sage.kernel.kernels.runtime.communication.queue_descriptor import resolve_descriptor
