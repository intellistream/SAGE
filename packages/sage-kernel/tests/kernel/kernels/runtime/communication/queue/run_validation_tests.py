...
def test_multithreading_concurrency():
    ...
    try:
        from sage.kernel.runtime.communication.queue_descriptor import create_python_queue
...
def test_sage_queue_concurrency():
    ...
    try:
        from sage.kernel.runtime.communication.queue_descriptor import create_sage_queue
