...
class TestNameServer:
    ...
    def test_get_name_basic(self):
        ...
        with patch('socket.gethostname') as mock_hostname, \
             patch('sage.kernel.kernels.jobmanager.utils.name_server.get_available_port') as mock_port:
    ...
    def test_get_name_uniqueness(self):
        ...
        with patch('socket.gethostname') as mock_hostname:
            ...
            with patch('sage.kernel.kernels.jobmanager.utils.name_server.get_available_port') as mock_port:
                # 模拟不同的端口返回
    ...
    def test_get_available_port_basic(self):
        """测试获取可用端口"""
        from sage.kernel.kernels.jobmanager.utils.name_server import get_available_port
...
class TestNameServerConfiguration:
    ...
    def test_name_validation(self):
        """测试名称验证"""
        from sage.kernel.kernels.jobmanager.utils.name_server import validate_name
    ...
    def test_name_registry_operations(self):
        """测试名称注册表操作"""
        from sage.kernel.kernels.jobmanager.utils.name_server import NameRegistry
    ...
    def test_name_lease_management(self):
        """测试名称租约管理"""
        from sage.kernel.kernels.jobmanager.utils.name_server import NameLease
...
class TestNameServerIntegration:
    ...
    def test_distributed_name_coordination(self):
        """测试分布式名称协调"""
        from sage.kernel.kernels.jobmanager.utils.name_server import DistributedNameCoordinator
