...
class BaseScheduler(ABC):
    ...
    def schedule_task(self, task_node: "TaskNode", runtime_ctx=None) -> "LocalTask":
        """
        调度任务（兼容性方法）
    ...
    def schedule_service(self, service_node: "ServiceNode", runtime_ctx=None) -> "LocalServiceTask":
        """
        调度服务（兼容性方法）
