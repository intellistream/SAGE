...
from sage.apps.lib.io_utils.sink import TerminalSink, FileSink
...
from sage.apps.lib.dataflow.splitter import Splitter
from sage.apps.lib.dataflow.merger import Merger
