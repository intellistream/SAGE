"""
测试 sage.apps.libs.rag.retriever 模块
"""
...
try:
    from sage.apps.libs.rag.retriever import DenseRetriever, BM25Retriever, HybridRetriever
...
class TestDenseRetriever:
    ...
    @patch('sage.apps.libs.rag.retriever.SentenceTransformer')
...
class TestBM25Retriever:
    ...
    def test_bm25_retriever_import(self):
        ...
        from sage.apps.libs.rag.retriever import BM25Retriever
    ...
    @patch('sage.apps.libs.rag.retriever.BM25Okapi')
...
class TestHybridRetriever:
    ...
    def test_hybrid_retriever_import(self):
        ...
        from sage.apps.libs.rag.retriever import HybridRetriever
...
class TestRetrieverExternal:
    ...
    def test_model_loading_failure(self):
        ...
        with patch('sage.apps.libs.rag.retriever.SentenceTransformer') as mock_transformer:
            # 模拟模型加载失败
