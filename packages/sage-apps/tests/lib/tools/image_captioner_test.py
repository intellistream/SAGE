...
# ================================
from sage.apps.libs.tools.image_captioner import ImageCaptioner
...
def test_execute_success(image_captioner_tool, mocker):
    ...
    mocker.patch('sage.apps.libs.tools.image_captioner.OpenAIClient', return_value=mock_client_instance)
