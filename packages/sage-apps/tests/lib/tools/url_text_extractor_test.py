...
# 假设您的源文件位于 sage.apps.lib/tools/url_text_extractor.py
# ================================
from sage.apps.libs.tools.url_text_extractor import URL_Text_Extractor_Tool
...
def test_general_error_handling(url_extractor_tool, mocker):
    ...
    mocker.patch('sage.apps.libs.tools.url_text_extractor.BeautifulSoup', side_effect=Exception(error_message))
