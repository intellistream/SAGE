...
# 源文件位于 sage.apps.libs.tools.text_detector
# ================================
from sage.apps.libs.tools.text_detector import text_detector
...
def test_cuda_out_of_memory_with_retry_and_clear_cache(detector_tool, mocker):
    ...
    mock_torch = mocker.patch('sage.apps.libs.tools.text_detector.torch')
...
#     mocker.patch('sage.apps.libs.tools.text_detector.torch')
