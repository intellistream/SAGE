...
from sage.apps.libs.rag.reranker import BGEReranker, LLMbased_Reranker
import torch
...
@patch("sage.apps.libs.rag.reranker.AutoTokenizer.from_pretrained")
@patch("sage.apps.libs.rag.reranker.AutoModelForSequenceClassification.from_pretrained")
...
@patch("sage.apps.libs.rag.reranker.AutoTokenizer.from_pretrained")
@patch("sage.apps.libs.rag.reranker.AutoModelForCausalLM.from_pretrained")
