...
from sage.apps.lib.rag.reranker import BGEReranker, LLMbased_Reranker
import torch
...
@patch("sage.apps.lib.rag.reranker.AutoTokenizer.from_pretrained")
@patch("sage.apps.lib.rag.reranker.AutoModelForSequenceClassification.from_pretrained")
...
@patch("sage.apps.lib.rag.reranker.AutoTokenizer.from_pretrained")
@patch("sage.apps.lib.rag.reranker.AutoModelForCausalLM.from_pretrained")
