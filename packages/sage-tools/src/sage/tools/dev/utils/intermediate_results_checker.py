...
class IntermediateResultsChecker:
    ...
    def __init__(self, project_root: str):
        ...
        # 定义允许在根目录存在的文件和目录
        self.allowed_items = {
            '.sage', '.git', '.github', '.gitignore', '.gitmodules', 
            'packages', 'docs', 'docs-public', 'examples', 'tools', 
            'scripts', 'experiments', 'data', 'test_env',
            'README.md', 'LICENSE', '_version.py', 'quickstart.sh',
            'pytest.ini', '.flake8', '.pypirc', '.github_token'
        }
