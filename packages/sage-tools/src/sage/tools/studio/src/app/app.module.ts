...
// 导入 NzPaginationModule
import { NzPaginationModule } from 'ng-zorro-antd/pagination';
import { OperatorEditorComponent } from './pages/operator-editor/operator-editor.component';
import { PipelineComponent } from "./pages/pipeline/pipeline.component";
import { DragDropModule } from '@angular/cdk/drag-drop';
import { OperatorPaletteComponent } from './pages/pipeline/operator-palette/operator-palette.component';
...
@NgModule({
  declarations: [
    ...
    CodeEditorComponent,
    OperatorEditorComponent,
    PipelineComponent,
    OperatorPaletteComponent,
    SubmitNewPipelineComponent
  ],
    imports: [
        BrowserModule,
        FormsModule,
