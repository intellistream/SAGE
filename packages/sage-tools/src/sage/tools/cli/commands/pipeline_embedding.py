...
class EmbeddingPipelineTemplates:
    ...
    def rag_with_embedding_service(
        ...
        **kwargs
        ...
        embedding_model = embedding_model or default_models.get(embedding_method, "BAAI/bge-small-zh-v1.5")
        ...
        **kwargs
        ...
        config["operators"] = [
            ...
            },
            {
                ...
                "type": "index_saver",
                "config": {
                    "output_path": kwargs.get("output_path", "data/index/")
                }
            }
        ]
...
def generate_embedding_pipeline(
    use_case: str,
    **kwargs
) -> Dict[str, Any]:
