...
def runPeriod(
    ...
    pqvqCodewordLookUpTableDir = (
        f"{exePath}/torchscripts/VQ/AMME2E/CodewordLookUpTable_unnormalized"
    )
...
def main():
    ...
    commonBasePath = (
        ...
        + "/results/AMME2E_static_lazy_unnormalized/"
    )

    figPath = (
        os.path.abspath(os.path.join(os.getcwd(), "../.."))
        + "/figures/AMME2E_static_lazy_unnormalized/"
    )
    ...
    # # dataSetNames=['ECO']
    # algosVec=['int8', 'blockLRA', 'vq', 'weighted-cr', 'int8_fp32']
    # algoDisp=['INT8', 'BlockLRA', 'VQ', 'WeightedCR', 'NLMM']
    # srcAVec=["datasets/BUS/gemat1.mtx",]
    # srcBVec=["datasets/BUS/gemat1.mtx",]
    # dataSetNames=['BUS']
    # srcAVec=['datasets/ECO/wm2.mtx']
    # srcBVec=['datasets/ECO/wm3.mtx']
    # dataSetNames=['ECO']
    ...
    groupBar2.DrawFigure2(
        ...
        5,
        15,
        figPath + "sec4_1_e2e_static_lazy_unnormalized_throughput_log",
        True,
    )
