...
def runPeriod(
    ...
    configTemplate = "config_e2e_static_eager.csv"
    # clear old files
    ...
    try:
        ...
        print(f"Error {e}")
        os.system(
            f"cd {exePath} && sudo cp scripts/AMME2E_default_results/default.csv {resultPath}/{prefixTag}/default.csv"
        )
...
def runPeriodVector(
    exePath, periodVec, pS, algoTag, resultPath, prefixTag, configTemplate="config.csv"
):
...
def main():
    ...
    commonBasePath = (
        os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/AMME2E_static_eager/"
    )

    figPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/AMME2E_static_eager/"
    ...
    groupBar2.DrawFigure(
        ...
        5,
        15,
        figPath + "sec4_1_e2e_static_eager_fro",
        True,
    )
    groupBar2.DrawFigure(
        dataSetNames,
        ...
        5,
        15,
        figPath + "sec4_1_e2e_static_eager_latency_log",
        True,
    )
    groupBar2.DrawFigure(
        dataSetNames,
        ...
        5,
        15,
        figPath + "sec4_1_e2e_static_eager_throughput_log",
        True,
    )
