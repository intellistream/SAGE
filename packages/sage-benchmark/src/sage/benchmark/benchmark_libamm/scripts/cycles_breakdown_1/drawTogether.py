...
def readResultVector(singleValueVec, resultPath):
    ...
    for i in singleValueVec:
        elapsedTime, cpuCycle, memStall, instructions, l1dStall, l2Stall, l3Stall, totalStall = (
...
def main():
    ...
    for valueChose in range(len(valueVec)):
        ...
        getCyclesPerMethod(totalStallAll, valueChose)
        ...
        accuBar.DrawFigure2(
            ...
            * 100.0,
            ...
            "",
            "Propotion (%)",
            figPath + "/" + "cyclesbreakDown" + "_cycles_accubar" + str(valueVec[valueChose]),
            allowLegend,
            "",
        )
        allowLegend = False
    ...
    groupBar2.DrawFigure2(
        dataSetNames, ipcAll, methodTags, "Datasets", "IPC", 5, 15, figPath + "ipc", True
    )
    groupBar2.DrawFigure2(
        dataSetNames,
        totalStallAll / cpuCycleAll * 100.0,
        methodTags,
        "Datasets",
        "Ratio of Stalls (%)",
        5,
    ...
    groupBar2.DrawFigure2(
        dataSetNames,
        l1dStallAll / cpuCycleAll * 100.0,
        methodTags,
        "Datasets",
        "Ratio of l1dStalls (%)",
        5,
        15,
        figPath + "l1dstall_ratio",
        True,
    )
    groupBar2.DrawFigure2(
        dataSetNames,
        l2StallAll / cpuCycleAll * 100.0,
        methodTags,
        "Datasets",
        "Ratio of l2Stalls (%)",
        5,
        15,
        figPath + "l2stall_ratio",
        True,
    )
    groupBar2.DrawFigure2(
        dataSetNames,
        l3StallAll / cpuCycleAll * 100.0,
        methodTags,
        "Datasets",
        "Ratio of l3Stalls (%)",
        5,
        15,
        figPath + "l3stall_ratio",
        True,
    )
    print(ipcAll)
