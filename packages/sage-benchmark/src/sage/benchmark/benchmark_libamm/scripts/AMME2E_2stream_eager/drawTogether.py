...
def runPeriod(
    ...
    configTemplate = "config_e2e_2stream_eager.csv"
    # clear old files
...
def main():
    ...
    commonBasePath = (
        os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/AMME2E_2stream_eager/"
    )
    ...
    groupBar2.DrawFigure2(
        ...
        5,
        15,
        figPath + "sec4_1_e2e_2stream_eager_throughput_log",
        True,
    )
