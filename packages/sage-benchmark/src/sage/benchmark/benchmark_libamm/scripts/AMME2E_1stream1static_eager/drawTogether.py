...
def main():
    ...
    commonBasePath = (
        ...
        + "/results/AMME2E_1stream1static_eager/"
    )

    figPath = (
        os.path.abspath(os.path.join(os.getcwd(), "../.."))
        + "/figures/AMME2E_1stream1static_eager/"
    )
    ...
    groupBar2.DrawFigure(
        ...
        5,
        15,
        figPath + "sec4_1_e2e_1stream1static_eager_fro",
        True,
    )
    groupBar2.DrawFigure(
        dataSetNames,
        ...
        5,
        15,
        figPath + "sec4_1_e2e_1stream1static_eager_latency_log",
        True,
    )
    groupBar2.DrawFigure(
        dataSetNames,
        ...
        5,
        15,
        figPath + "sec4_1_e2e_1stream1static_eager_throughput_log",
        True,
    )
