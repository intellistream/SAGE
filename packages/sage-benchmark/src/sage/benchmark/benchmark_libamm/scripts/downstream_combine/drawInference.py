...
def runPeriod(
    ...
    # pragma: allowlist secret ('/home/yuhao/Documents/work/SUTD/AMM/codespace/NEWLibAMM/LibAMM/benchmark/', 'dummy', 'dummy', 'int8', '/home/yuhao/Documents/work/SUTD/AMM/codespace/NEWLibAMM/LibAMM/benchmark/results/Downstream_Inference_static_lazy/int8', 'config_dnn_inference.csv', 'cifar10')
    ...
    # blockLRA rank ratio
    editConfig(
        exePath + "temp2.csv", exePath + "temp1.csv", "algoARankRatio", 16 * 16 / 10000
    )  # num of subspace * ncodebook / num of rows
    ...
    if algoTag == "vq":
        pqvqCodewordLookUpTablePath = glob.glob(
            f"{pqvqCodewordLookUpTableDir}/{prefixTag}_train_m1_*"
        )[0]
    elif algoTag == "pq":
        pqvqCodewordLookUpTablePath = glob.glob(
            f"{pqvqCodewordLookUpTableDir}/{prefixTag}_train_m10_*"
        )[0]
    editConfig(
        exePath + "temp1.csv",
        exePath + configFname,
...
def tryBolt():
    ...
    while tryDownload < 10:
        os.system(
            "wget https://www.dropbox.com/scl/fi/94q58vbbhgeij0kvamwmx/bolt.tar?rlkey=vnjhl92rlz7vrnf2jf440dyi4"
        )
...
def main():
    ...
    # run
    reRun = 2
    lat95All, errAll, ebAll, thrAll, periodAll, endingAccAll = compareMethod(
        exeSpace,
        commonBasePath,
        resultPaths,
        csvTemplate,
    ...
    groupBar2.DrawFigure2(
        ...
        5,
        15,
        figPath + "sec4_1_inference_static_lazy_fro",
        True,
    )
    groupBar2.DrawFigure2(
        dataSetNames,
        ...
        5,
        15,
        figPath + "sec4_1_inference_static_lazy_ending_acc",
        True,
    )
    groupBar2.DrawFigure2(
        dataSetNames,
        ...
        5,
        15,
        figPath + "sec4_1_inference_static_lazy_latency_log",
        True,
    )
