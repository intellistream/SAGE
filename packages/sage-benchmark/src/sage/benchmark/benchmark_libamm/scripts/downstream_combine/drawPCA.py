...
dataset_acols_mapping = {"SIFT10K": 10000, "SIFT1M": 1000000, "GIST1M": 1000000}
...
def runPeriod(
    ...
    # run
    os.system(
        "export OMP_NUM_THREADS=1 &&" + "cd " + exePath + "&& sudo ./benchmarkPCA " + configFname
    )
...
def main():
    ...
    commonBasePath = (
        os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/DownstreamPCA_static_lazy/"
    )
    if not os.path.exists(commonBasePath):
        os.makedirs(commonBasePath)
    figPath = (
        os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/DownstreamPCA_static_lazy/"
    )
    ...
    groupBar2.DrawFigure2(
        ...
        5,
        15,
        figPath + "sec4_1_pca_static_lazy_throughput_log",
        True,
    )
    return lat95All, errAll, endingErrorAll
