...
def readResultVector(singleValueVec, resultPath):
    ...
    errorBoundRatioVec = []
    for i in singleValueVec:
        elapsedTime, cacheMiss, cacheRefs, froError, errorBoundRatio = readResultSingle(
            i, resultPath
        )
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        reRun = 1
    # skech
    elapsedTimeAll, cacheMissAll, periodAll, fro, eb = compareMethod(
    ...
    groupLine.DrawFigureYnormal(
        ...
        0,
        100,
        figPath + "/" + scanTag + "sketch_cpp_froError",
        True,
    )
    groupLine.DrawFigureYnormal(
        periodAll,
        ...
        0,
        100,
        figPath + "/" + scanTag + "sketch_cpp_ebRatio",
        True,
    )
    ...
    groupLine.DrawFigureYnormal(
        ...
        0,
        100,
        figPath + "/" + scanTag + "sampling_cpp_froError",
        True,
    )
    groupLine.DrawFigureYnormal(
        periodAll,
        ...
        0,
        100,
        figPath + "/" + scanTag + "sampling_cpp_ebRatio",
        True,
    )
