...
% ---------------------------------------------------------------------------
% Figure 1: SAGE layered architecture (L1--L6), showing packages and
...
%    - L6 (sage-cli, sage-studio, sage-tools, sage-gateway): CLI, studio,
%      tools, and OpenAI-compatible API.
%
