...
\fbox{\parbox{0.95\linewidth}{
      \vspace{0.35cm}
      \centering
      \textbf{Placeholder: SAGE end-to-end architecture (L1--L5).}\\
      Show the five layers, downward-only dependencies, and the main data/control paths\\
      (CLI/Tools $\rightarrow$ Middleware $\rightarrow$ Runtime/Libs $\rightarrow$ Platform $\rightarrow$ Foundation).
      \vspace{0.35cm}
}}
