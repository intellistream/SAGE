#!/bin/bash
# 运行 Locomo 长轮对话记忆实验 - MemoryBank 批量测试
# 使用方法: bash script/run_locomo_memorybank.sh

set -e  # 遇到错误立即退出

# 获取脚本所在目录的绝对路径
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# 获取项目根目录 (从 script/primitive_memory_model/ 向上 9 层到 SAGE/)
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../../../../../../.." && pwd)"
# Python 脚本的相对路径
PYTHON_SCRIPT="$SCRIPT_DIR/../../memory_test_pipeline.py"
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/primitive_memory_model/locomo_memorybank_pipeline.yaml"
...
echo "========================================================================"
echo "Locomo 长轮对话记忆实验 - MemoryBank 批量测试"
echo "========================================================================"
echo ""
