#!/bin/bash
# 运行 Locomo 长轮对话记忆实验 - HippoRAG 批量测试
# 使用方法: bash script/run_locomo_hipporag.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/primitive_memory_model/locomo_hipporag_pipeline.yaml"
...
echo "========================================================================"
echo "Locomo 长轮对话记忆实验 - HippoRAG 批量测试"
echo "========================================================================"
echo ""
