#!/bin/bash
# 运行 TiM Locomo PreRetrieval 实验 - validate
# 使用方法: bash script/query_formulation_strategy/run_tim_locomo_validate.sh
...
# 配置文件路径
CONFIG_FILE="$SCRIPT_DIR/../../config/query_formulation_strategy/TiM_locomo_validate_pre_retrieval_pipeline.yaml"
...
echo "========================================================================"
echo "TiM Locomo PreRetrieval 实验 - validate"
echo "========================================================================"
echo ""
