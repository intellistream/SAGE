...
> **代码位置**: `services/` 目录下的各 Memory Service 实现 **配置方式**: `services.register_memory_service` 指定服务名
...
> **代码位置**: `libs/pre_insert.py` **配置方式**: `operators.pre_insert.action`
...
> **代码位置**: `libs/post_insert.py` **配置方式**: `operators.post_insert.action`
...
> **代码位置**: `libs/pre_retrieval.py` **配置方式**: `operators.pre_retrieval.action`
...
> **代码位置**: `libs/post_retrieval.py` **配置方式**: `operators.post_retrieval.action` + 参数
