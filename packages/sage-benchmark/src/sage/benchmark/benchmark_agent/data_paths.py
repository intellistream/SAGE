...
def print_data_paths_summary() -> None:
    ...
    print("\n📂 Source Data (read-only, via DataManager):")
    ...
    print("\n📂 Runtime Data (generated, in .sage/):")
    ...
    print(f"   Source data exists: {'✅' if source_exists else '❌'}")
    print(f"   Runtime data exists: {'✅' if runtime_exists else '❌'}")
    print("=" * 60)
