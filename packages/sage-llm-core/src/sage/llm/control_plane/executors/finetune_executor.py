...
"""Fine-tune executor for managing fine-tuning tasks through Control Plane.
...
Architecture:
    Control Plane (sageLLM) manages fine-tune engines similar to LLM/embedding engines:
...
class FinetuneEngine:
    ...
    async def start(self) -> None:
        ...
        try:
            # Lazy-import FinetuneManager (avoid import-time dependency)
