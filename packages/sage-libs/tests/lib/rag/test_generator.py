...
try:
    from sage.libs.rag.generator import OpenAIGenerator, HFGenerator
...
class TestOpenAIGenerator:
    ...
    def test_execute_with_dict_input(self, mock_openai_client):
        ...
        mock_client_instance.generate.assert_called_once_with("Please explain artificial intelligence.")
...
class TestOpenAIGeneratorIntegration:
    ...
    def test_generator_with_mock_service(self):
        ...
        with patch('sage.libs.rag.generator.OpenAIClient') as mock_openai_client:
            ...
            # 测试完整的数据流
            test_data = ["Analyze the following context and answer the question.", "What is machine learning?"]
            ...
            assert len(result) == 2
            user_query, response = result
            assert user_query == "Analyze the following context and answer the question."
...
class TestGeneratorIntegration:
    ...
    def test_multiple_generators_comparison(self):
        ...
        with patch('sage.libs.rag.generator.OpenAIClient') as mock_openai, \
...
class TestHFGenerator:
    ...
    def test_hf_generator_execute_with_tuple_input(self, mock_hf_client):
        ...
        mock_client_instance.generate.assert_called_once_with("Answer the following question: What is AI?")
    ...
    def test_hf_generator_execute_with_single_input(self, mock_hf_client):
        ...
        mock_client_instance.generate.assert_called_once_with(["Generate a response for this prompt"])
