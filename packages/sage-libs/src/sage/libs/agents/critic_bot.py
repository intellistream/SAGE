...
class CriticBot(MapFunction):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.logger.info(
            f"CriticBot initialized with threshold: {quality_threshold}, strict_mode: {strict_mode}"
        )
    ...
    def _create_critic_evaluation(self, eval_data: Dict[str, Any]) -> CriticEvaluation:
        ...
        evaluation = CriticEvaluation(
            ...
            + eval_data.get("missing_elements", []),
    ...
    def _add_evaluation_metadata(
        self, template: ModelContext, evaluation: CriticEvaluation
    ) -> None:
        """
        将评估元数据添加到template中
    ...
    def _log_evaluation_summary(
        ...
        """记录评估摘要"""
        self.logger.info(
            f"Critic evaluation #{self.evaluation_count}: "
    ...
    def execute(self, template: ModelContext) -> ModelContext:
        ...
        try:
            ...
            self.logger.debug(
                f"Built evaluation prompts with {len(evaluation_prompts)} messages"
            )
...
class EnhancedCriticBot(CriticBot):
    ...
    def __init__(
        ...
        enable_iterative_feedback: bool = True,
        **kwargs,
    ):
        ...
        self.logger.info(
            f"EnhancedCriticBot initialized with iterative feedback: {enable_iterative_feedback}"
        )

    def _analyze_improvement_over_iterations(
