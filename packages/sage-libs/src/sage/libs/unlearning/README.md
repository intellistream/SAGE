...
**Research Focus**: Selective unlearning with differential privacy that preserves utility on retained data while providing provable privacy guarantees.
...
2. **Utility**: Retained data should work as before
3. **Efficiency**: Fast unlearning without retraining
4. **Verifiability**: Provable guarantees of unlearning
...
2. Run `examples/unlearning/basic_unlearning_demo.py`
3. Understand each component's role
...
2. Implement your novel algorithm
3. Add unit tests
4. Create examples demonstrating your method
...
2. Cao & Yang (2015): "Towards Making Systems Forget with Machine Unlearning"
3. Bourtoule et al. (2021): "Machine Unlearning" (SISA)

### Advanced Topics
4. Mironov (2017): "Renyi Differential Privacy"
5. Bun & Steinke (2016): "Concentrated Differential Privacy"
6. Guo et al. (2019): "Certified Data Removal"

### Recent Work
7. Sekhari et al. (2021): "Remember What You Want to Forget"
8. Chundawat et al. (2023): "Zero-Shot Machine Unlearning"
9. Jia et al. (2023): "Model Sparsity Can Simplify Machine Unlearning"
...
**Remember**: This is a research project, not just coding!
Focus on:
