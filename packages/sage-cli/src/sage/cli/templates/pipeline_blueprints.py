...
BLUEPRINT_LIBRARY: tuple[PipelineBlueprint, ...] = (
    PipelineBlueprint(
        ...
        description="Use the sage.benchmark_rag.implementations.rag_simple operators to run an end-to-end retrieval and answer pipeline.",
        keywords=(
            "rag",
            "qa",
            "retrieval",
        ...
        source=SourceSpec(
            ...
            class_path="sage.benchmark_rag.implementations.rag_simple.SimpleQuestionSource",
        ...
        stages=(
            StageSpec(
                ...
                kind="map",
                class_path="sage.benchmark_rag.implementations.rag_simple.SimpleRetriever",
            ...
            StageSpec(
                ...
                kind="map",
                class_path="sage.benchmark_rag.implementations.rag_simple.SimplePromptor",
            ...
            StageSpec(
                ...
                kind="map",
                class_path="sage.benchmark_rag.implementations.rag_simple.SimpleGenerator",
        ...
        sink=SinkSpec(
            id="terminal-sink",
            title="Terminal Sink",
            class_path="sage.benchmark_rag.implementations.rag_simple.SimpleTerminalSink",
            summary="Pretty-print answers to the terminal with context snippets.",
        ),
        notes=(
            "基于 sage.benchmark_rag.implementations.rag_simple 模块构建，适合离线演示",
            "无需外部服务或大模型依赖即可运行",
        ),
        graph_channels=(
            {
    ...
    PipelineBlueprint(
        ...
        source=SourceSpec(
            ...
            class_path="sage.benchmark_rag.implementations.qa_multimodal_fusion.MultimodalQuestionSource",
        ...
        stages=(
            StageSpec(
                ...
                kind="map",
                class_path="sage.benchmark_rag.implementations.qa_multimodal_fusion.MultimodalFusionRetriever",
        ...
        notes=(
            "基于 sage.benchmark_rag.implementations.qa_multimodal_fusion 模块",
