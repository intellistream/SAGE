...
class NeuroMemVDBService(BaseService):
    ...
    def retrieve(self, query_text: str, topk: int = 5, collection_name: Optional[str] = None, 
                with_metadata: bool = False, **kwargs) -> List[Any]:
        """
        ...
        if collection_name:
            ...
            collections_to_search = {collection_name: self.online_register_collections[collection_name]}
        else:
            # 在所有注册的collection上检索
