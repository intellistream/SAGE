...
#include "stream_data_source_stats.hpp"
...
public:
   ...
   */
  auto get_streaming_stats() const -> StreamDataSourceStats;
...
private:
  ...
  // Streaming state (similar to SAGE's KafkaSourceFunction background
  // processing)
