...
public:
   ...
   */
  virtual auto AddVector(uint64_t id,
                         const std::vector<float>& vector) -> bool = 0;
   ...
   */
  virtual auto Search(const std::vector<float>& query_vector,
                      size_t k) const -> std::vector<SearchResult> = 0;
