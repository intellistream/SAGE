...
- **[API Reference](api_reference.md)**：Stream 类方法、类型提示、示例代码，参考 PyFlink 和 Polars。
- **[User Guide](user_guide.md)**：安装、快速开始、配置并行度、NumPy 集成、懒惰评估解释。
- **[Development Guide](development.md)**：构建项目、运行测试、贡献指南。
