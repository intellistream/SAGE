...
def test_vdb(do_reload=True, do_delete=True):
    ...
    from sage.llm.embedding.mockembedder import MockTextEmbedder
    import os
...
# def kvtest():
#     from sage.core.sage.service.memory..memory_manager import MemoryManager
#     import os
...
#     if user_input.strip().lower() == "yes":
#         from sage.core.sage.service.memory.memory_collection.kv_collection import KVMemoryCollection
