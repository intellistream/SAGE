...
# def kvtest():
#     from sage.core.api.sage.service.memory..memory_manager import MemoryManager
#     import os
...
#     if user_input.strip().lower() == "yes":
#         from sage.core.api.sage.service.memory.memory_collection.kv_collection import KVMemoryCollection
