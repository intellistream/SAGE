"""
测试 sage.middleware.operators.rag.pipeline 模块
"""
...
class TestRAGPipeline:
    ...
    def test_run_with_reranker_without_documents(self):
        ...
        pipeline = RAGPipeline(
            retriever=mock_retriever, reranker=mock_reranker, generator=mock_generator
        )
    ...
    def test_run_with_kwargs(self):
        ...
        mock_generator.generate.assert_called_once_with(
            query, mock_documents, top_k=5, temperature=0.7
        )
    ...
    def test_run_with_refiner_but_no_reranker(self):
        ...
        pipeline = RAGPipeline(
            retriever=mock_retriever, refiner=mock_refiner, generator=mock_generator
        )
