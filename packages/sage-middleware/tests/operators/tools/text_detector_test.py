...
# 源文件位于 sage.middleware.operators.tools.text_detector
# ================================
...
def test_cuda_out_of_memory_with_retry_and_clear_cache(detector_tool, mocker):
    ...
    mock_torch = mocker.patch("sage.middleware.operators.tools.text_detector.torch")
...
#     mocker.patch('sage.middleware.operators.tools.text_detector.torch')
