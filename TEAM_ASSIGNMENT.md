...
> **注意**：sageFlow 已独立为公开仓库 `intellistream/sageFlow`
>
> **资助计划**：计划以 sageFlow 为主体申请 2026 年国家自然科学基金面上项目
>
> **项目简介**：向量原生流处理引擎，已独立为 PyPI 包 `isage-flow`
...
> **注意**：sageDB 已独立为公开仓库 `intellistream/sageDB`
>
> **资助状态**：暂无独立基金支持，归属 SAGE 主项目（国家优青）
>
> **项目简介**：自研高性能 C++ 向量数据库，已独立为 PyPI 包 `isagedb`

| 姓名   | sageDB 任务                   | 备注      |
| ------ | ----------------------------- | --------- |
| 高鸿儒 | Graph-based ANNS 内存访问优化 | 20 届博士 |
| 万睿朋 | ANNS 算法研究                 |           |
| 雷昕延 | ANNS 算法研究                 |           |

> **研究方向**：高性能向量检索、ANNS 算法优化、内存访问优化
...
以下项目与 SAGE 生态相关性较弱或相对独立，但由课题组成员参与：

- **华为 Flink 横向合作项目**：流计算系统研究（参与人员：杨锦昀）
- **时序敏感 RAG 研究**：相对独立研究（参与人员：周宇童）
- **大模型安全研究**：相对独立研究，不基于 SAGE（参与人员：王笑涵）

## 变更记录

- 2026-01-04：添加相对独立研究成员（周宇童、王笑涵）到"其他课题组项目"
