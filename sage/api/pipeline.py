...
class Pipeline:
    name:str
    operators: list[Union[BaseOperator, Type[BaseOperator] ]]
    ...
    def add_source(self,source: Union[Type[BaseFunction], BaseFunction], config:dict = {}) -> DataStream:
        """
        ...
        Returns:
            DataStream: 数据流对象
        """
        if(isinstance(source, BaseFunction)):
