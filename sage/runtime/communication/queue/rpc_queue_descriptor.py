...
class RPCQueueDescriptor(QueueDescriptor):
    """
    RPC队列描述符
    ...
    def _create_queue_instance(self) -> Any:
        ...
        try:
            ...
            from sage.runtime.communication.rpc.rpc_queue import RPCQueue
            ...
            logger.info(f"Successfully initialized RPC Queue: {self.queue_id} at {self.host}:{self.port}")
            return rpc_queue
