...
from runtime.service.service_caller import ServiceManager, ServiceCallProxy
if TYPE_CHECKING:
    from runtime.runtime_context import RuntimeContext
    from runtime.service.service_caller import ServiceManager
import logging
from utils.state_persistence import load_function_state, save_function_state
...
class BaseFunction(ABC):
    ...
    def call_service(self):
        ...
        if self._call_service_proxy is None:
            from runtime.service.service_caller import ServiceCallProxy
