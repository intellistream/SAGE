# file sage/core/neuromem/search_engine/kv_index/bm25s_index.py
# python -m sage.core.neuromem.search_engine.kv_index.bm25s_index
...
from sage.core.neuromem.search_engine.kv_index.base_kv_index import BaseKVIndex
