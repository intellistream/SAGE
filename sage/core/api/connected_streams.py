...
from core.transformation.join_transformation import JoinTransformation
...
from core.function.join_function import BaseJoinFunction
if TYPE_CHECKING:
...
class ConnectedStreams:
    ...
    def comap(self, function: Union[Type[BaseFunction], callable], *args, **kwargs) -> 'DataStream':
        ...
        from core.transformation.comap_transformation import CoMapTransformation
