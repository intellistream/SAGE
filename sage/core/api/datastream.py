...
from core.transformation.filter_transformation import FilterTransformation
from core.transformation.flatmap_transformation import FlatMapTransformation
from core.transformation.map_transformation import MapTransformation
from core.transformation.sink_transformation import SinkTransformation
from core.transformation.source_transformation import SourceTransformation
from core.transformation.keyby_transformation import KeyByTransformation
from core.function.base_function import BaseFunction
from core.function.lambda_function import wrap_lambda, detect_lambda_type
...
class DataStream(Generic[T]):
    ...
    def print(self, prefix: str = "", separator: str = " | ", colored: bool = True) -> "DataStream":
        ...
        Example:
            ...
            ```
        """
        from libs.io.sink import PrintSink
