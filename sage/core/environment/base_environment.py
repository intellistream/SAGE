...
from core.function.lambda_function import wrap_lambda
import memory.api
from core.api.datastream import DataStream
from core.transformation.base_transformation import BaseTransformation
from core.transformation.source_transformation import SourceTransformation
from core.transformation.batch_transformation import BatchTransformation
from core.transformation.future_transformation import FutureTransformation
from utils.custom_logger import CustomLogger
from jobmanager.utils.name_server import get_name
...
class BaseEnvironment(ABC):
    ...
    def set_memory(self, config = None):
        self.memory_collection = memory.api.get_memory(config=config, remote=(self.platform != "local"), env_name=self.name)
    ...
    def register_service(self, service_name: str, service_class: Type, *args, **kwargs):
        ...
        # 创建服务任务工厂
        from jobmanager.factory.service_task_factory import ServiceTaskFactory
    ...
    def from_kafka_source(self, 
        ...
        """
        from core.function.kafka_source import KafkaSourceFunction
    ...
    def from_batch_collection(self, data: list, **kwargs) -> DataStream:
        ...
        """
        from core.function.simple_batch_function import SimpleBatchIteratorFunction
    ...
    def from_batch_file(self, file_path: str, encoding: str = 'utf-8', **kwargs) -> DataStream:
        ...
        """
        from core.function.simple_batch_function import FileBatchIteratorFunction
    ...
    def from_batch_range(self, start: int, end: int, step: int = 1, **kwargs) -> DataStream:
        ...
        """
        from core.function.simple_batch_function import RangeBatchIteratorFunction
    ...
    def from_batch_generator(self, generator_func: callable, total_count: int = None, **kwargs) -> DataStream:
        ...
        """
        from core.function.simple_batch_function import GeneratorBatchIteratorFunction
    ...
    def from_batch_iterable(self, iterable: Any, total_count: int = None, **kwargs) -> DataStream:
        ...
        """
        from core.function.simple_batch_function import IterableBatchIteratorFunction
