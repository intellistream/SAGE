...
# ================================
from libs.tools.text_detector import text_detector
...
def test_cuda_out_of_memory_with_retry_and_clear_cache(detector_tool, mocker):
    ...
    mock_torch = mocker.patch('sage_libs.tools.text_detector.torch')
...
def test_fails_after_max_retries(detector_tool, mocker):
    ...
    mocker.patch('sage_libs.tools.text_detector.torch')
