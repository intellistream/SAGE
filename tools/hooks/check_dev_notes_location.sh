...
if [ -n "$violations" ]; then
    ...
    echo "  - ${dev_notes_root}/l5-cli/             # L5 CLI 层"
    echo "  - ${dev_notes_root}/l5-tools/           # L5 Tools 层"
    echo ""
    ...
    echo ""
    echo "📦 独立仓库 (不在 SAGE 核心架构中):"
    echo "  - sage-benchmark: 基准测试"
    echo "  - sage-examples: 应用示例"
    echo "  - sage-studio: Web UI"
    echo "  - sageLLM: LLM 推理引擎"
    echo ""
    echo "💡 提示:"
