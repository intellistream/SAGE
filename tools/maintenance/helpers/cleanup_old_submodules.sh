#!/bin/bash
# 🧹 清理旧的 sage_db、sage_flow 和 sage_llm submodule 配置
...
OLD_SUBMODULES=(
    ...
    "packages/sage-middleware/src/sage/middleware/components/sage_llm"
    "packages/sage-middleware/src/sage/middleware/components/sage_llm/sageLLM"
)
