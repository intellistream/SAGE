...
RUNTIME_MANAGER_SUBMODULE_PATH="${SAGE_ROOT}/third_party/ascend-runtime-manager"
...
EXPECTED_RUNTIME_MANAGER_COMMIT="${SAGE_ASCEND_RUNTIME_MANAGER_COMMIT:-c5b0461aaecffe7e5011f8fab0944d32bedb1092}"
