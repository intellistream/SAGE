...
def main():
    ...
    try:
        ...
        print("\n📚 Learn more:")
        print("   - Full documentation: packages/sage-kernel/src/sage/kernel/fault_tolerance/README.md")
        print("   - Quick reference: packages/sage-kernel/src/sage/kernel/fault_tolerance/QUICK_REFERENCE.md")
        print("   - More examples: packages/sage-kernel/src/sage/kernel/fault_tolerance/examples.py")
