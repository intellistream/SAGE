...
```python
from examples.tutorials.L5_apps.adaptive_rag import (
    AdaptiveRAGPipeline,
...
```python
from examples.tutorials.L5_apps.adaptive_rag import ComplexityFilterFunction
...
```python
from examples.tutorials.L5_apps.adaptive_rag import build_adaptive_rag_pipeline
...
from examples.tutorials.L5_apps.adaptive_rag import build_sage_pipeline
...
```python
from examples.tutorials.L5_apps.adaptive_rag import create_classifier
...
```python
from examples.tutorials.L5_apps.adaptive_rag import NoRetrievalFunction
...
```python
from examples.tutorials.L5_apps.adaptive_rag import SingleRetrieverFunction
...
```python
from examples.tutorials.L5_apps.adaptive_rag import IterativeRetrieverFunction
...
```bash
# 运行完整示例
python examples/tutorials/L5-apps/adaptive_rag/example.py

# 或者在 Python 中交互式运行
python -c "from examples.tutorials.L5_apps.adaptive_rag import AdaptiveRAGPipeline; print('OK')"
```
...
```python
from examples.tutorials.L5_apps.adaptive_rag.classifier import (
    BaseClassifier,
...
```python
from examples.tutorials.L5_apps.adaptive_rag.functions import BaseRAGStrategyFunction
