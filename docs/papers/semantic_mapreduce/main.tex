...
\end{tikzpicture}
\caption{Motivating result. The gray bars show workflow boundaries that stop at symptoms or window fragments; semantic reduction changes the output unit into evidence-linked incident hypotheses.}
