...
| The reducer contract executes over external public data. | `run_aiops2020_semantic_reduce_contract_replay.py` consumes only detected official AIOps windows, commits a bounded evidence-preserving edit, rejects a missing-evidence edit, preserves the baseline, records digests/replay ID, and replays deterministically. | "external public-data contract conformance"; never "public reducer-quality generalization." |
