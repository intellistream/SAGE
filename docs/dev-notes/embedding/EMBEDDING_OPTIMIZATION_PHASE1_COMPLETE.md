...
from sage.components.sage_embedding import EmbeddingModel

emb = EmbeddingModel(method="mockembedder", fixed_dim=128)
vec = emb.embed("test")

# ✅ 旧的 apply_embedding_model 仍然可用
from sage.components.sage_embedding import apply_embedding_model

emb = apply_embedding_model(name="hf", model="...")

# ✅ MockTextEmbedder 仍然可用
from sage.components.sage_embedding.mockembedder import MockTextEmbedder
