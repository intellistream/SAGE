...
- Added a typed, versioned compiled-workflow plan fingerprint/cache foundation with bounded LRU/TTL, failure recovery, single-flight compilation, metrics, and request-neutral runtime binding.
