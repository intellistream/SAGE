...
2. **混合工作负载**: 评估系统处理不同类型作业的能力
3. **资源规划**: 确定系统可以稳定支持的并发作业数量
4. **调度策略评估**: 观察不同启动策略对整体性能的影响

## 注意事项

1. **资源限制**: 确保集群有足够资源运行所有作业
2. **避免 OOM**: 并发作业数过多可能导致内存不足
3. **网络带宽**: 多作业并发可能增加网络压力
4. **监控指标**: 建议同时监控系统资源使用情况
