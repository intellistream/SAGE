...
try:
    ...
    from models import QueryEvent, JoinedEvent, DocumentEvent
except ImportError:
    ...
    from workload4.models import QueryEvent, JoinedEvent, DocumentEvent
...
def example_4_advanced_bfs_traversal():
    ...
    print(f"✓ 分层知识图:")
    print(f"  - 第 0 层 (root): 1 个节点")
    print(f"  - 第 1 层 (child): 3 个节点")
    print(f"  - 第 2 层 (leaf): 4 个节点")
