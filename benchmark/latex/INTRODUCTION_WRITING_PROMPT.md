...
2. **使用绝对数值** - "16 tasks/sec", "99.8% balance", "57% reduction", "8× scaling"
3. **强调系统特性** - 扩展性、多策略支持、多租户能力
4. **提供设计洞察** - "optimal concurrency", "no single policy dominates"
5. **保持谦逊但自信** - 使用 "characterize", "demonstrate", "reveal" 而非 "outperform", "beat"
